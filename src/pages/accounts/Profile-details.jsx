...
export default function ProfileDetails() {
  ...
  return (
    <>
      ...
      <Container className="profile-breadcrumb">
        <div
      ...
      <Container className="py-5 profile-page" style={{ maxWidth: "1140px" }}>
        <Row className="profile-grid">
          {/* Sidebar */}
          <Col md={3} className="profile-sidebar">
            <div style={{ borderRight: "1px solid #ddd", paddingRight: "10px" }} className="profile-sidebar-inner">
              <div className="profile-nav-item" style={sidebarItemStyle} onClick={() => navigate("/profile-details")}>Profile &gt;</div>
              <div className="profile-nav-item" style={sidebarItemStyle} onClick={() => navigate("/order-details")}>Orders &gt;</div>
              <div className="profile-nav-item" style={sidebarItemStyle} onClick={() => navigate("/wishlist")}>Wishlist &gt;</div>
              <div className="profile-nav-item" style={sidebarItemStyle} onClick={() => navigate("/address-details")}>Address Book &gt;</div>
              <div className="profile-nav-item" style={sidebarItemStyle} onClick={handleLogout}>Log Out &gt;</div>
            </div>
          </Col>

          {/* Profile Form */}
          <Col md={9} className="profile-content">
            <h2 className="profile-title" style={{ fontFamily: "Montserrat", fontWeight: "600", marginBottom: "30px" }}>Your Profile</h2>
            <Form className="profile-form">
              ...
              <Row className="mb-4 profile-row">
                <Col md={3} className="profile-label" style={{ fontFamily: "Poppins", fontWeight: "500" }}>Password</Col>
                <Col md={9} className="profile-field">
                  <Form.Control
                    type="text"
                    value="************"
                    readOnly
              ...
              <div className="d-flex justify-content-end profile-actions">
                <Button
...
const renderInputRow = (label, name, value, onChange, readOnly = false, type = "text") => (
  <Row className="mb-4 profile-row" key={name}>
    <Col md={3} className="profile-label" style={{ fontFamily: "Poppins", fontWeight: "500" }}>{label}</Col>
    <Col md={9} className="profile-field">
      <Form.Control
        type={type}
        name={name}
