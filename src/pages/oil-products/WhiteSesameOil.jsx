...
const WhiteSesameOil = () => {
  const images = [{src:"/media/oil-whitesesame.png", weight:"500ml", price: 350},
     {src:"/media/whitesesame-one.png", weight:"1L", price: 750},
    {src:"/media/nutrition-white-sesame.jpeg"},{src:"/media/uses-white-sesame.jpeg"},
  {src:"/media/benefits-white-sesame.jpeg"},
{src:"/media/color-white-sesame.jpeg"}];
           ...
           <Table bordered responsive className="mt-4" >
                          <tbody>
                            <tr>
                              ...
                              <td style={{fontFamily:"poppins",padding:"15px"}}>₹350.00 <del className="text-muted">₹650.00</del> <span className="text-success">20% Off</span></td>
                            </tr>
                            <tr>
