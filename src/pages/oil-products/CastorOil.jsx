...
const CastorOil = () => {
  const images = [ { src:"/media/oil-castor.jpeg",weight:"500ml", price:"250"},
    { src: "/media/castor-one.png", weight:"1L", price:"500"},
     { src: "/media/nutrition-castor.jpeg"},
    { src: "/media/uses-castor.jpeg"},
  { src :"/media/benefit-castor.jpeg"},
{src :"/media/color-vary-castor.jpeg"}];
      ...
      borderRadius: "10px",
        ...
        <Col md={6} style={{ padding: "40px" }}>
          ...
          <h4 style={{ color: "#00614A", fontFamily: "Montserrat" }}>
              ...
              <span className="ms-2 text-success">30% OFF</span>
            </h4>
         ...
         <Table bordered responsive className="mt-4" >
                <tbody>
                  <tr>
                    ...
                    <td style={{fontFamily:"poppins",padding:"15px"}}>₹500.00 <del className="text-muted">₹800.00</del> <span className="text-success">20% Off</span></td>
                  </tr>
                  <tr>
