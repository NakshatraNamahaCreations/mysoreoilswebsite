...
const Yelludeepam = () => {
  const images = [{src:"/media/yellu-oil.jpeg", weight:"1L", price:450},{src:"/media/uses-yellu-deepam.jpeg"},
    {src:"/media/color-yellu-deepam.jpeg"}
  ];
          ...
          <Table bordered responsive className="mt-4" >
                          <tbody>
                            <tr>
                              ...
                              <td style={{fontFamily:"poppins",padding:"15px"}}>₹450.00 <del className="text-muted">₹750.00</del> <span className="text-success">20% Off</span></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              ...
                              <td style={{fontFamily:"poppins", padding:"15px"}}>(1L)</td>
                            </tr>
