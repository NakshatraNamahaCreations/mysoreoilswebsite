...
const SafflowerOil = () => {
  const images = [{ src:"/media/safflower-one.png", weight:"1L", price: 480 },
    { src:"/media/safflower-five.png", weight:"5L", price: 700},
  { src:"/media/nutrition-sunflower.jpeg"},
{src:"/media/uses-sunflower.jpeg"},
{src:"/media/benefits-sunflower.jpeg"},
{src:"/media/color-sunflower.jpeg"}];
      ...
      borderRadius: "10px",
        ...
        <Col md={6} style={{ padding: "40px" }}>
          ...
          <h4 style={{ color: "#00614A", fontFamily: "Montserrat" }}>
              ...
              <span className="ms-2 text-danger text-decoration-line-through">₹700</span>
            ...
            <Table bordered responsive className="mt-4" >
                          <tbody>
                            <tr>
                              ...
                              <td style={{fontFamily:"poppins",padding:"15px"}}>₹480.00 <del className="text-muted">₹700.00</del> <span className="text-success">20% Off</span></td>
                            </tr>
                            <tr>
