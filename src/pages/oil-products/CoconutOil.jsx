...
const CoconutOil = () => {
  const images = [{src: "/media/oil-coconut.jpeg", weight:"1L", price:"550"},
    { src: "/media/coconut-five.png", weight:"5L", price:"2750"},
  { src: "/media/nutrition-coconut.jpeg"},
{ src:"/media/uses-coconut.jpeg"},
{ src:"/media/benefit-coconut.jpeg"},
{ src:"/media/color-may-vary-coconut.jpeg"}];
       ...
       <div className="d-flex flex-wrap justify-content-center gap-5">
        ...
        <Col md={6} style={{ padding: "40px" }}>
          ...
          <h4 style={{ color: "#00614A", fontFamily: "Montserrat" }}>
              ...
              <span className="ms-2 text-danger text-decoration-line-through">₹750</span>
          ...
          <Table bordered responsive className="mt-4" >
                <tbody>
                  <tr>
                    ...
                    <td style={{fontFamily:"poppins",padding:"15px"}}>₹550.00 <del className="text-muted">₹750.00</del> <span className="text-success">20% Off</span></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td style={{fontFamily:"poppins", padding:"15px"}}>(1L)(5L)</td>
                  </tr>
