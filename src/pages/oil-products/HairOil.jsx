...
const HairOil = () => {
  const images = [{ src: "/media/oil-hair.png", weight:"100ml", price:"350"},
    {src:"/media/uses-hairoil.jpeg"},
    {src:"/media/color-vary-hairoil.jpeg"}
  ];
      ...
      borderRadius: "10px",
        ...
        <Col md={6} style={{ padding: "40px" }}>
          ...
          <h4 style={{ color: "#00614A", fontFamily: "Montserrat" }}>
              ...
              <span className="ms-2 text-danger text-decoration-line-through">₹550</span>
         ...
         <Table bordered responsive className="mt-4" >
                        <tbody>
                          <tr>
                            ...
                            <td style={{fontFamily:"poppins",padding:"15px"}}>₹350.00 <del className="text-muted">₹550.00</del> <span className="text-success">20% Off</span></td>
                          </tr>
                          <tr>
