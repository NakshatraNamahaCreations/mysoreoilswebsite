...
const HongeOil = () => {
  const images = [{src:"/media/oil-honge.png", weight:"100ml", price:"450"},
    {src:"/media/uses-honge-oil.jpeg"},
    { src:"/media/color-vary-honge.jpeg"}
  ];
      ...
      borderRadius: "10px",
        ...
        <Col md={6} style={{ padding: "40px" }}>
          ...
          <h4 style={{ color: "#00614A", fontFamily: "Montserrat" }}>
              ...
              <span className="ms-2 text-danger text-decoration-line-through">₹600</span>
           ...
           <Table bordered responsive className="mt-4" >
                          <tbody>
                            <tr>
                              ...
                              <td style={{fontFamily:"poppins",padding:"15px"}}>₹450.00 <del className="text-muted">₹600.00</del> <span className="text-success">20% Off</span></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              ...
                              <td style={{fontFamily:"poppins", padding:"15px"}}>
                                <ul className="list-unstyled mb-0">
                                  ...
                                  <li className="mb-2"><FaCheckCircle color="green" className="me-2" />Cold Pressed</li>
