...
const DeepamOil = () => {
  const images = [{src:"/media/oil-deepam.jpeg", weight:"1L", price:"480"},
    { src:"/media/uses-deepam.jpeg "},
    { src :"/media/color-deepam.jpeg"}
  ];
         ...
         <Table bordered responsive className="mt-4" >
                <tbody>
                  <tr>
                    ...
                    <td style={{fontFamily:"poppins",padding:"15px"}}>₹480.00 <del className="text-muted">₹600.00</del> <span className="text-success">20% Off</span></td>
                  </tr>
                  <tr>
