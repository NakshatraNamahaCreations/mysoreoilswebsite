...
const BlackSesameOil = () => {
  const images = [
  { src: "/media/500ML.png", weight: "500 ml", price: 280 },
  { src: "/media/oil-black-sesame.jpeg", weight: "1L", price: 580 },
  { src: "/media/nutrition-black-sesame.jpeg"},
  { src:"/media/uses-black-sesame.jpeg "},
  {src :"/media/benefits-black-sesame.jpeg"},
  {src: "/media/color-may-vary.jpeg"}
];


  const [price, setPrice] = useState(580); // default: 580 for 1L
          ...
          <Table bordered responsive className="mt-4" >
                <tbody>
                  <tr>
                    ...
                    <td style={{fontFamily:"poppins",padding:"15px"}}>₹280.00 <del className="text-muted">₹580.00</del> <span className="text-success">20% Off</span></td>
                  </tr>
                  <tr>
